            ...
            <Drawer title="Add Account" onClose={onClose} open={open} >
                ...
                >
                    ...
                    <div className='position-relative'>
                        <BaseInput type="select" placeholder="Spend From name" label="Expense From" />
                    ...
                    <BaseInput type="select" placeholder="Enter Account here" label="Account" />
                    <BaseInput type="" placeholder="" label="Paid To" />
                    <BaseInput type="" placeholder="" label="Paid By" />

                    <BaseInput type="datepiker" placeholder="22 Apr, 2025" label="Date" />
                    <BaseInput type="select" placeholder="Enter Cheque No." label="Cheque No." />
                    ...
                    <FlatButton htmlType="submit" className="save-btn login-btn bg-purple mt-2" title="Save & Print" />

                </Form>
            </Drawer>
            <Drawer title="Expense Report" onClose={onClose} open={OpenBallance} >
                <Form
                    name="basic"
                    initialValues={{ remember: true }}
                    onFinish={onFinish}
